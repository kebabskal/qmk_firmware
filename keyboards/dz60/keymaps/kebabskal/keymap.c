...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT_all(
        ...
        KC_LGUI, KC_LALT, KC_LCTL, KC_SPC, MO(1), KC_SPC, MO(2), KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT),

    LAYOUT_all(
        KC_NUBS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, KC_DEL,
    ...
    LAYOUT_all(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P1, KC_P2, KC_P3, KC_TRNS, KC_TRNS,
